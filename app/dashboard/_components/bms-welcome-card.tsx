      ...
      <div className="relative z-10 flex w-[60%] flex-col gap-2.5 p-4 sm:p-5">
        ...
        <div>
          <p className="text-[10px] font-medium uppercase tracking-widest text-primary-foreground/60">
            Sisa Saldo Minggu Ini
          </p>
          <p
            className={cn(
              "mt-0.5 font-mono text-2xl font-extrabold tracking-tight text-white sm:text-3xl",
        ...
        {isLocked ? (
          <div className="flex items-center gap-1.5 rounded-lg bg-black/25 px-2.5 py-1.5">
            ...
            <p className="text-[10px] leading-snug text-red-100">
              Saldo terkunci — PJUM menunggu persetujuan BNM Manager
            </p>
          </div>
        ) : (
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] text-primary-foreground/50">
              dari {formatCurrency(balance.initialBalance)}
            </span>
          </div>
        )}
      </div>
