...
export function ImportStoresDialog({ branches }: { branches: string[] }) {
    ...
    function handleImport() {
        ...
        startTransition(async () => {
            try {
                ...
                const importResult = await adminImportStoresWithBranch(formData);
                setResult(importResult);

                if (importResult.success && importResult.failed === 0) {
                    toast.success("Import toko berhasil", {
                        description: `${importResult.created} dibuat, ${importResult.updated} diperbarui, ${importResult.skipped} dilewati.`,
                    });
                } else if (importResult.success) {
                    toast.warning("Import toko selesai dengan catatan", {
                        description: `${importResult.failed} baris gagal. Lihat detail di panel hasil.`,
                    });
                } else {
                    toast.error("Import toko gagal", {
                        description: importResult.errors[0] ?? "Terjadi kendala.",
                    });
                }
            } catch {
                toast.error("Import toko gagal", {
        ...
        >
            ...
            <DialogContent className="sm:max-w-lg">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Import data toko secara massal melalui file XLSX. Kolom
                        cabang wajib diisi per baris.
                    </DialogDescription>
                </DialogHeader>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="space-y-2 flex-1">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Kolom wajib:{" "}
                                    <strong>Kode Toko, Nama Toko, Cabang</strong>
                                    . Nama cabang harus sesuai dengan data yang
                                    ada di sistem.
                                </p>
                                <Button
                                    type="button"
                    ...
                    {result && !isPending && (
                        <div className="rounded-lg border p-4 space-y-3">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center">
                                {[
                                    { label: "Dibuat", value: result.created, color: "text-green-600" },
                                    { label: "Diperbarui", value: result.updated, color: "text-blue-600" },
