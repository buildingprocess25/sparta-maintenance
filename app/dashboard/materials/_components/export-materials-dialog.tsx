...
export function ExportMaterialsDialog({ branches }: { branches: string[] }) {
    ...
    const handleExport = async () => {
        setIsLoading(true);
        const toastId = toast.loading("Menyiapkan file ekspor material...");
        ...
        try {
            const res = await fetch("/api/admin/export", {
                ...
                body: JSON.stringify({
                    ...
                    sheets: ["materials"], // Only export materials sheet
                }),
            });
            ...
            a.href = url;
            a.download = `List_Material_${format(new Date(), "yyyyMMdd")}.xlsx`;
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Ekspor List Material</DialogTitle>
                    <DialogDescription>
