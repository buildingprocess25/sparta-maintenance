    ...
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      ...
      <Card className="transition-colors hover:border-primary/40">
        <CardHeader>
          <div className="flex items-start justify-between gap-3">
            <div className="flex flex-col gap-1">
              <CardDescription>Rata-rata per Laporan</CardDescription>
              <CardTitle className="text-2xl font-semibold">
      ...
      <Card className="transition-colors hover:border-primary/40">
        <CardHeader>
          <div className="flex items-start justify-between gap-3">
            <div className="flex flex-col gap-1">
              <CardDescription>Efisiensi Anggaran</CardDescription>
      ...
      <CardHeader>
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <CardDescription>
              Detail efisiensi anggaran setiap cabang, diurutkan dari total
              realisasi terbesar
            </CardDescription>
          </div>
        </div>
                ...
                return (
                  <TableRow key={branch.branchName}>
                    ...
                    <TableCell className="text-right">
                      {formatNumber(branch.completedCount)}
                    </TableCell>
                    ...
                    <TableCell className="text-right font-mono tabular-nums">
                      {formatRp(branch.avgRealisasi)}
                    </TableCell>
                    <TableCell className="min-w-32">
                      <div className="flex w-full items-center">
                        <Progress
                          value={(branch.totalRealisasi / maxRealisasi) * 100}
                          className="w-full"
                        />
                      </div>
                    </TableCell>
