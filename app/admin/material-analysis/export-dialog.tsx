...
export function ExportMaterialAnalysisDialog({ branches }: { branches: string[] }) {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Gagal mengekspor data", { id: toastId });
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Pilih kriteria data material yang ingin Anda ekspor ke Excel.</DialogDescription>
        </DialogHeader>
