...
import type { WorkableReport } from "../queries";

interface ReportSelectDialogProps {
    open: boolean;
    reports: WorkableReport[];
    onSelect: (reportNumber: string) => void;
    onCancel: () => void;
}

export function ReportSelectDialog({
    open,
    reports,
    onSelect,
    onCancel,
}: ReportSelectDialogProps) {
    ...
    const labelFor = (r: WorkableReport) =>
        `${r.reportNumber} - ${r.storeName}`;

    const handleSelect = (r: WorkableReport) => {
        ...
        <AlertDialog open={open}>
            <AlertDialogContent className="sm:max-w-md">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Cari dan pilih laporan yang sedang dikerjakan. Klik OK
                        untuk melanjutkan.
                    </AlertDialogDescription>
                </AlertDialogHeader>
