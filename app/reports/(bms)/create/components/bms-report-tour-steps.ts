...
export function getBmsInputTourSteps({
  activeStep,
  isRepairOnlyMode,
}: {
    ...
    steps.push(
      {
        ...
        title: "Penanganan",
        content:
          "Tentukan siapa yang akan menangani perbaikan ini, apakah tim internal BMS atau pihak ketiga (Rekanan).",
        placement: "bottom",
        skipBeacon: true,
      },
      {
      ...
      },
      {
        ...
        title: "Catatan",
        content:
          "Tambahkan catatan mengenai kerusakan atau tindakan yang diperlukan.",
        placement: "bottom",
        skipBeacon: true,
      },
      {
    ...
    return [
      {
        ...
        content: "Klik untuk menambahkan estimasi barang/material.",
        placement: "bottom",
        skipBeacon: true,
      },
      {
        ...
        title: "Pilih Item Rusak",
        content: "Pilih item rusak yang akan diestimasi.",
        placement: "bottom",
        skipBeacon: true,
      },
      {
        ...
        content: "Masukkan nama spesifik dari barang/material.",
        placement: "bottom",
        skipBeacon: true,
      },
      {
      ...
      },
      {
        ...
        title: "Harga Satuan",
        content:
          "Masukkan estimasi harga satuan. Harga Rp 0 diperbolehkan jika tidak ada biaya atau ditanggung pihak lain.",
        placement: "bottom",
        skipBeacon: true,
      },
      {
